...
/**
 * The Pilates class implements the Session interface and represents a specific type of session in a system.
 */
public class Pilates implements Session {
    ...
    private final  int finalQuantity = 30;
    /**
     ...
     * @param i2
     */
    public Pilates(String s, ForumType forumType, Instructor i2) {
        this.time = s;
